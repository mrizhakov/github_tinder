...
export default function Deck({ users, onSwipe }: DeckProps) {
  ...
  if (!currentUser) {
    return (
      <div className="flex flex-col items-center justify-center h-[400px] w-[280px] bg-white rounded-2xl shadow-xl p-8">
  ...
  return (
    <div className="relative w-[280px] h-[400px]">
      ...
      {/* Action Buttons */}
      <div className="absolute bottom-[-80px] left-0 right-0 flex justify-center items-center gap-6 z-10">
        <button
          onClick={() => swipe('left')}
          className="w-14 h-14 bg-white rounded-full flex items-center justify-center shadow-lg border-2 border-red-500 hover:scale-110 transition-transform duration-200"
        >
        ...
        <button
          onClick={() => swipe('right')}
          className="w-14 h-14 bg-white rounded-full flex items-center justify-center shadow-lg border-2 border-green-500 hover:scale-110 transition-transform duration-200"
        >
